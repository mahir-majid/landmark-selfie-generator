...
class InfUFluxPipeline:
    ...
    def __call__(
        ...
        infu_source_img_token: Optional[str] = None,  # Token to associate with identity
        cpu_offload = False,
    ):        
        ...
        image = self.pipe(
            ...
            infu_source_img_token=infu_source_img_token,  # Pass token for identity association
        ).images[0]
